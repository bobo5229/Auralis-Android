...
static jobject metadataResultSuccess(JNIEnv *env, jobject metadata) {
    JClassRef jSuccessClass { env,
            "com/bobo/auralis/mobile/library/metadata/MetadataResult$Success" };
    jmethodID jInitMethod = jSuccessClass.method("<init>",
            "(Lcom/bobo/auralis/mobile/library/metadata/Metadata;)V");
...
static jobject metadataResultNoMetadata(JNIEnv *env) {
    return metadataResultObject(env,
            "com/bobo/auralis/mobile/library/metadata/MetadataResult$NoMetadata");
}

static jobject metadataResultNotAudio(JNIEnv *env) {
    return metadataResultObject(env,
            "com/bobo/auralis/mobile/library/metadata/MetadataResult$NotAudio");
}

static jobject metadataResultProviderFailed(JNIEnv *env) {
    return metadataResultObject(env,
            "com/bobo/auralis/mobile/library/metadata/MetadataResult$ProviderFailed");
}

extern "C" JNIEXPORT jobject JNICALL
Java_com_bobo_auralis_mobile_library_metadata_TagLibJNI_openNative(JNIEnv *env,
        jobject /* this */,
        jobject inputStream) {
