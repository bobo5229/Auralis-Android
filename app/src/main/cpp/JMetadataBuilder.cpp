...
jobject JMetadataBuilder::build() {
    JClassRef jPropertiesClass { env, "com/bobo/auralis/mobile/library/metadata/Properties" };
    ...
    JClassRef jMetadataClass { env, "com/bobo/auralis/mobile/library/metadata/Metadata" };
    jmethodID jMetadataInitMethod = jMetadataClass.method("<init>",
            "(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;[BLcom/"
                    "bobo/auralis/mobile/library/metadata/Properties;)V");
